...
export const Payment = () => {
  ...
  return !order || !styles ? (
    <div style={style}>
      <p>Hang on while we confirm your payment with your bank...</p>
    </div>
  ) : (
    <div className={styles.container}>
      ...
      <div>
        <p>An order confirmation will be sent to you at {order.email} Thank you for shopping with Us! We hope to see you soon again.😊</p>
      </div>
    </div>
  );
};
